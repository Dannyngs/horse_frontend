(function() {
  ...
  function config($logProvider, toastrConfig,$translateProvider) {
    ...
    ABOUT_CONTENT:'Our company, RACING PRO, has invested horse racing matches in Hong Kong for many years. Our company owns a very strong Horse Racing database. What’s more, we hire specially-assigned persons to analyze each competition in order to make horse racing becomes <a >a professional investment with abundant profits</a>. All horse racing matches are calculated by the program and data. When the data meet the requirement, the program will provide some information for you to bet. Professional horse racing program RACING PRO charges one-off fee, and members may use it permanently. <a >We provide independent entry account for each person</a>.',
    ABOUT_GT1:'STRONG DATABASE',ABOUT_GT2:'AFTER-SALE SERVICE',ABOUT_GT3:'PROFESSIONAL ANALYSIS',
    ABOUT_GC1:'Our company owns<a > horse racing data</a> for many years',
    ABOUT_GC2:'<a >Answer all questions</a> about the program and matches to members' ,
    ABOUT_GC3:'In order to <a >improve the winning rate</a>, specially-assigned persons analyze each match'   ,
  ...
  $translateProvider.translations('chinese', {
    ...
    SLIDE3:'Data analysis',SLIDE4:'of competition',
    SLIDE5:'Simple',SLIDE6:'and easy to use',
    ABOUT_CONTENT:"本公司RACING PRO 多年來鑽研香港賽馬賽事, 公司擁有超強大賽馬數據庫,更有專人分析每場賽事, 令到賽馬變成一項<a >專業而帶有豐厚利益的投資</a>.所有賽馬賽事用程式及數據計算,當數據達到要求就可以投注賽事.RACING PRO專業賽馬程式一次性收費,永久使用,<a >所有會員設有獨立登入户口</a>.",
       ABOUT_GT1:'強大數據庫',ABOUT_GT2:'售後服務',ABOUT_GT3:'專業分析',
    ABOUT_GC1:'本公司擁有多年來<a >賽馬數據</a>',
    ABOUT_GC2:'<a >解答會員</a>所有程式或賽事問題' ,
    ABOUT_GC3:'專人分析每場賽事,令到<a >勝率大大提高</a>',
    TERMS:'服務條款',
